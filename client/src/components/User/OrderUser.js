...
export default function OrderUser() {
  ...
  const { orders } = useSelector((state) => state.order?.listOrder) || {}; // Provide a default empty object if orders is undefined
  ...
  useEffect(() => {
    ...
    getListOrderUser(dispatch, query);
  }, [dispatch, user.id]); // Include dispatch and user.id in the dependency array
        ...
        <div className="container">
          <div className="row px-4 px-lg-5 py-lg-4 align-items-center">
            <div className="col-lg-6">
              <h1 className="h2 text-uppercase mb-0">Order</h1>
            </div>
