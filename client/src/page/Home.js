              ...
              <div className="col-md-4 mb-4 mb-md-0">
                <NavLink className="category-item" to="/shop">
                  <img
                    ...
                    alt=""
                  />
                  <strong className="category-item-title">Smart Phones</strong>
                </NavLink>
              </div>
              <div className="col-md-4 mb-4 mb-md-0">
                ...
                <NavLink className="category-item" to="/shop">
                  <img
                    ...
                    alt=""
                  />
                  <strong className="category-item-title">Perfume</strong>
                </NavLink>
              </div>
              <div className="col-md-4">
                <NavLink className="category-item" to="/shop">
                  <img
                    ...
                    alt=""
                  />
                  <strong className="category-item-title">Skincare</strong>
                </NavLink>
              </div>
            </div>
          </div>
